...
callbacks = [
    ModelCheckpoint('densenet121_bone_fracture_100epoch.keras', save_best_only=True, monitor='val_loss', mode='min')
]
...
for layer in base_model.layers[-20:]:  # Unfreeze the last 20 layers of DenseNet121
...
test_steps = np.ceil(test_generator.samples / test_generator.batch_size)  # Calculate test_steps
