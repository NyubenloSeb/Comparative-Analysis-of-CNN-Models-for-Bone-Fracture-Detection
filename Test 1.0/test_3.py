...
from tensorflow.keras.applications import MobileNet  # Use MobileNet instead of VGG16
...
# Load the MobileNet model with pretrained weights from ImageNet, without the top (classification) layer
...
callbacks = [
    ModelCheckpoint('mobilenet_bone_fracture.keras', save_best_only=True, monitor='val_loss', mode='min'),
...
for layer in base_model.layers[-4:]:  # Unfreeze the last 4 layers of MobileNet
