...
from tensorflow.keras.applications import VGG16  # Use VGG16 instead of EfficientNetB0
...
callbacks = [
    ModelCheckpoint('vgg16_bone_fracture.keras', save_best_only=True, monitor='val_loss', mode='min'),
...
for layer in base_model.layers[-4:]:  # Unfreeze the last 4 layers of VGG16
